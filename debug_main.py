#!/usr/bin/env python3
"""
Debug version of Dragofactu main application to track visibility issues
"""
...
class DebugMainWindow(QMainWindow):
    """Debug version of MainWindow with logging"""
    
    def __init__(self):
        debug_print("DebugMainWindow.__init__() starting")
        super().__init__()
        self.current_user = None
        
        debug_print("Setting window properties")
        self.setWindowTitle("DEBUG Dragofactu")
        ...
        label = QLabel("DEBUG WINDOW - If you see this, MainWindow works!")
        label.setAlignment(Qt.AlignCenter)
        label.setStyleSheet("font-size: 18px; color: red; padding: 50px;")
        layout.addWidget(label)
        
        debug_print("MainWindow setup complete")
...
class DebugApp(QApplication):
    def __init__(self):
        debug_print("DebugApp.__init__() starting")
    ...
    def setup_ui(self):
        ...
        self.main_window = DebugMainWindow()
...
def main():
    ...
    debug_print("=== DEBUG DRAGOFACTU STARTUP ===")
